...
\begin{figure}[!ht]
   \subfloat[Walking \label{fig:walk}]{
      \includegraphics[width=0.45\linewidth]{walk.png}
   }
   \subfloat[Sitting-Standing \label{fig:ss}]{
      \includegraphics[width=0.45\linewidth]{sit-stand.png}
   }
...
~\pageref{fig:jump}.
\begin{figure}[!ht]
   \subfloat[Jumping \label{fig:jump}]{
      \includegraphics[width=0.45\linewidth]{jump.png}
   }
   \subfloat[Sleeping \label{fig:sleep}]{
      \includegraphics[width=0.45\linewidth]{sleep.png}
   }
